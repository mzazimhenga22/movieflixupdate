...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Find the key for the current accent color
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: ElevatedButton(
                ...
                child: Text(localizations.clearCache),  // <-- use clearCache here
              ),
            ),
            ListTile(
              ...
              trailing: DropdownButton<String>(
                ...
                onChanged: (String? newValue) {
                  if (newValue != null) {
                    settings.setAccentColor(availableBackgroundColors[newValue]!);
                  }
                },
              ),
            ),
